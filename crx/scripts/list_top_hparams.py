import argparse
import numpy as np
from crx.learning import model_selection
from crx.utils import reporting


if __name__ == "__main__":
    """
    Example usage:
    python -u -m crx.scripts.list_top_hparams --input_dir ... --algorithm ERM --dataset Waterbirds
    """
