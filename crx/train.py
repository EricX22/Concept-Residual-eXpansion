...
if __name__ == "__main__":
    ...
    hparams.setdefault("stage1_model", "model.pkl")
    hparams.setdefault("stage1_hparams_seed", 0)
    hparams.setdefault("stage1_seed", 0)
    hparams.setdefault("group_balanced", False)
    hparams.setdefault("optimizer", "sgd")
    hparams.setdefault("nonlinear_classifier", False)
    hparams.setdefault("pretrained", True)
    hparams.setdefault("last_layer_dropout", 0.0)
    hparams.setdefault("resnet18", False)
